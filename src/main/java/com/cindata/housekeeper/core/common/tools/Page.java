...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/> / "+ getTotalPage() +"页，");
		sb.append("每页显示<input type=\"text\" value=\""+ pageSize +"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
...
//	}
	...
	public void setCount(long count) {
		...
		this.pageLocation=(this.pageNo-1)*this.pageSize;
	}
	...
	public String getJsonArrayByList(){
		String ret = null;
		try {
			JSONArray json = JSONArray.fromObject(this.list);
			ret = json.toString();
		} catch (Exception e) {
			e.printStackTrace();
		}
